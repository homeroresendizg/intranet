...
<head>
    ...
    <title>BBB Industries de México | Calendar</title>
...
<body>
    ...
    <div class="header-section text-center mx-auto">
        <h3 class="title-big"><span>Calendar</span></h3>
    </div>
    <br>
    <div align="center" width="1800px" height="1500px">
        <iframe class="embed-responsive-item" src="http://192.168.1.68/bbb_ISO9001/calendar/calendar_events/" width="1500px" height="800px" frameborder="0"></iframe>
    </div>
    <br>
                ...
                <div class="d-flex below-section justify-content-between align-items-center pt-4 mt-5">
                    <div class="columns text-lg-left text-center">
                        <p>&copy;
                            ...
                            rights reserved. Developed by <a href="http://emirhernandez.epizy.com/" target="_blank" style="color:#fe5a0e;">Emir Hernandez</a> and <a href="https://homeroresendiz.dev/" target="_blank" style="color:#fe5a0e;">Homero Resendiz</a> <strong> Business Information Department</strong>.
                        </p>
                        </p>
                    </div>
                </div>
