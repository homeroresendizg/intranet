...
class grid_iso_no_conformidad_1_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_iso_no_conformidad_1/grid_iso_no_conformidad_1_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_iso_no_conformidad_1_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_iso_no_conformidad_1.zip";
          $this->Arquivo   .= "_grid_iso_no_conformidad_1" . $this->Xls_tp;
          $this->Tit_doc    = "grid_iso_no_conformidad_1" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_iso_no_conformidad_1_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_iniciador()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->iniciador, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->iniciador, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sac
   function NM_export_sac()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sac, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sac, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nombre_proceso
   function NM_export_nombre_proceso()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_proceso, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_proceso, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha_apertura
   function NM_export_fecha_apertura()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fecha_apertura = substr($this->fecha_apertura, 0, 10);
         if (empty($this->fecha_apertura) || $this->fecha_apertura == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_apertura, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_apertura, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fecha_apertura);
   ...
   function NM_export_fecha_cierre()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fecha_cierre = substr($this->fecha_cierre, 0, 10);
         if (empty($this->fecha_cierre) || $this->fecha_cierre == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fecha_cierre);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_numero_parte()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numero_parte, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numero_parte, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- clausula_iso
   function NM_export_clausula_iso()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->clausula_iso, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->clausula_iso, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- descrip_problema
   function NM_export_descrip_problema()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->descrip_problema, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->descrip_problema, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- contencion
   function NM_export_contencion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->contencion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->contencion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- causa_raiz
   function NM_export_causa_raiz()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->causa_raiz, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->causa_raiz, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- imp_acc_correc
   function NM_export_imp_acc_correc()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->imp_acc_correc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->imp_acc_correc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- responsable
   function NM_export_responsable()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->responsable, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->responsable, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha_compro
   function NM_export_fecha_compro()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fecha_compro = substr($this->fecha_compro, 0, 10);
         if (empty($this->fecha_compro) || $this->fecha_compro == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_compro, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_compro, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fecha_compro);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_fehca_real()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fehca_real = substr($this->fehca_real, 0, 10);
         if (empty($this->fehca_real) || $this->fehca_real == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fehca_real, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fehca_real, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fehca_real);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   //----- iniciador
   function NM_sub_cons_iniciador()
   {
         $this->iniciador = html_entity_decode($this->iniciador, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->iniciador = strip_tags($this->iniciador);
         $this->iniciador = NM_charset_to_utf8($this->iniciador);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->iniciador;
   ...
   //----- sac
   function NM_sub_cons_sac()
   {
         $this->sac = html_entity_decode($this->sac, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sac = strip_tags($this->sac);
         $this->sac = NM_charset_to_utf8($this->sac);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sac;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nombre_proceso
   function NM_sub_cons_nombre_proceso()
   {
         $this->nombre_proceso = html_entity_decode($this->nombre_proceso, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre_proceso = strip_tags($this->nombre_proceso);
         $this->nombre_proceso = NM_charset_to_utf8($this->nombre_proceso);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nombre_proceso;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fecha_apertura
   function NM_sub_cons_fecha_apertura()
   {
         $this->fecha_apertura = substr($this->fecha_apertura, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_apertura;
   ...
   //----- numero_parte
   function NM_sub_cons_numero_parte()
   {
         $this->numero_parte = html_entity_decode($this->numero_parte, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->numero_parte = strip_tags($this->numero_parte);
         $this->numero_parte = NM_charset_to_utf8($this->numero_parte);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numero_parte;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- clausula_iso
   function NM_sub_cons_clausula_iso()
   {
         $this->clausula_iso = html_entity_decode($this->clausula_iso, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->clausula_iso = strip_tags($this->clausula_iso);
         $this->clausula_iso = NM_charset_to_utf8($this->clausula_iso);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->clausula_iso;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- descrip_problema
   function NM_sub_cons_descrip_problema()
   {
         $this->descrip_problema = html_entity_decode($this->descrip_problema, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->descrip_problema = strip_tags($this->descrip_problema);
         $this->descrip_problema = NM_charset_to_utf8($this->descrip_problema);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->descrip_problema;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- contencion
   function NM_sub_cons_contencion()
   {
         $this->contencion = html_entity_decode($this->contencion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->contencion = strip_tags($this->contencion);
         $this->contencion = NM_charset_to_utf8($this->contencion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->contencion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- causa_raiz
   function NM_sub_cons_causa_raiz()
   {
         $this->causa_raiz = html_entity_decode($this->causa_raiz, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->causa_raiz = strip_tags($this->causa_raiz);
         $this->causa_raiz = NM_charset_to_utf8($this->causa_raiz);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->causa_raiz;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- imp_acc_correc
   function NM_sub_cons_imp_acc_correc()
   {
         $this->imp_acc_correc = html_entity_decode($this->imp_acc_correc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->imp_acc_correc = strip_tags($this->imp_acc_correc);
         $this->imp_acc_correc = NM_charset_to_utf8($this->imp_acc_correc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imp_acc_correc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- responsable
   function NM_sub_cons_responsable()
   {
         $this->responsable = html_entity_decode($this->responsable, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->responsable = strip_tags($this->responsable);
         $this->responsable = NM_charset_to_utf8($this->responsable);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->responsable;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fecha_compro
   function NM_sub_cons_fecha_compro()
   {
         $this->fecha_compro = substr($this->fecha_compro, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_compro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   //----- fehca_real
   function NM_sub_cons_fehca_real()
   {
         $this->fehca_real = substr($this->fehca_real, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fehca_real;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_iso_no_conformidad_1']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
