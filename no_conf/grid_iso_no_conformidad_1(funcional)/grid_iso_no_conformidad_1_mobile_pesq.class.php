...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_apertura";$Nm_datas[] = "fecha_apertura";$Nm_datas[] = "fecha_cierre";$Nm_datas[] = "fecha_cierre";$Nm_datas[] = "fecha_compro";$Nm_datas[] = "fecha_compro";$Nm_datas[] = "fehca_real";$Nm_datas[] = "fehca_real";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_iniciador_cond" name="iniciador_cond" onChange="nm_campos_between(document.getElementById('id_vis_iniciador'), this, 'iniciador')">
      ...
      <br><span id="id_hide_iniciador"  <?php echo $str_hide_iniciador?>><?php
      if ($iniciador != "")
      {
      $iniciador_look = substr($this->Db->qstr($iniciador), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sac_cond" name="sac_cond" onChange="nm_campos_between(document.getElementById('id_vis_sac'), this, 'sac')">
      ...
      <br><span id="id_hide_sac"  <?php echo $str_hide_sac?>><?php
      if ($sac != "")
      {
      $sac_look = substr($this->Db->qstr($sac), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombre_proceso_cond" name="nombre_proceso_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_proceso'), this, 'nombre_proceso')">
      ...
      <br><span id="id_hide_nombre_proceso"  <?php echo $str_hide_nombre_proceso?>><?php
      if ($nombre_proceso != "")
      {
      $nombre_proceso_look = substr($this->Db->qstr($nombre_proceso), 1, -1); 
      $nmgp_def_dados = array(); 
