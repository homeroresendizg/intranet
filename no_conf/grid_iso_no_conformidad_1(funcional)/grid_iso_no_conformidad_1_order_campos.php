<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_iso_no_conformidad_1']['glo_nm_path_imag_temp'] . "/sc_apl_default_BBB_ISO9001.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_iso_no_conformidad_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_iso_no_conformidad_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['iniciador'] = "on";
   $tab_def_campos['iniciador'] = "iniciador";
   $tab_labels["iniciador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["iniciador"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["iniciador"] : "Iniciador";
   $tab_ger_campos['sac'] = "on";
   $tab_def_campos['sac'] = "sac";
   $tab_labels["sac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["sac"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["sac"] : "SAC#";
   $tab_ger_campos['nombre_proceso'] = "on";
   $tab_def_campos['nombre_proceso'] = "nombre_proceso";
   $tab_labels["nombre_proceso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["nombre_proceso"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["nombre_proceso"] : "Nombre Proceso";
   $tab_ger_campos['fecha_apertura'] = "on";
   $tab_def_campos['fecha_apertura'] = "fecha_apertura";
   $tab_labels["fecha_apertura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_apertura"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_apertura"] : "Fecha Apertura";
   $tab_ger_campos['fecha_cierre'] = "on";
   $tab_def_campos['fecha_cierre'] = "fecha_cierre";
   $tab_labels["fecha_cierre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_cierre"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_cierre"] : "Fecha Cierre";
   $tab_ger_campos['numero_parte'] = "on";
   $tab_def_campos['numero_parte'] = "numero_parte";
   $tab_labels["numero_parte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["numero_parte"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["numero_parte"] : "Numero Parte";
   $tab_ger_campos['clausula_iso'] = "on";
   $tab_def_campos['clausula_iso'] = "clausula_iso";
   $tab_labels["clausula_iso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["clausula_iso"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["clausula_iso"] : "Clausula ISO";
   $tab_ger_campos['descrip_problema'] = "on";
   $tab_def_campos['descrip_problema'] = "descrip_problema";
   $tab_labels["descrip_problema"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["descrip_problema"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["descrip_problema"] : "Descripción del Problema";
   $tab_ger_campos['contencion'] = "on";
   $tab_def_campos['contencion'] = "contencion";
   $tab_labels["contencion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["contencion"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["contencion"] : "Contención";
   $tab_ger_campos['causa_raiz'] = "on";
   $tab_def_campos['causa_raiz'] = "causa_raiz";
   $tab_labels["causa_raiz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["causa_raiz"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["causa_raiz"] : "Causa Raíz";
   $tab_ger_campos['imp_acc_correc'] = "on";
   $tab_def_campos['imp_acc_correc'] = "imp_acc_correc";
   $tab_labels["imp_acc_correc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["imp_acc_correc"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["imp_acc_correc"] : "Implementar Acciones Correctivas";
   $tab_ger_campos['responsable'] = "on";
   $tab_def_campos['responsable'] = "responsable";
   $tab_labels["responsable"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["responsable"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["responsable"] : "Responsable";
   $tab_ger_campos['fecha_compro'] = "on";
   $tab_def_campos['fecha_compro'] = "fecha_compro";
   $tab_labels["fecha_compro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_compro"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fecha_compro"] : "Fecha Compromiso";
   $tab_ger_campos['fehca_real'] = "on";
   $tab_def_campos['fehca_real'] = "fehca_real";
   $tab_labels["fehca_real"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fehca_real"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['labels']["fehca_real"] : "Fehca Real";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_iso_no_conformidad_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
