...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_iso_no_conformidad_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_iso_no_conformidad_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_iso_no_conformidad']['error_buffer']) && '' != $_SESSION['scriptcase']['form_iso_no_conformidad']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_iso_no_conformidad']['error_buffer'];
}
...
<?php
 include_once("form_iso_no_conformidad_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_iso_no_conformidad_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_iso_no_conformidad_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_iso_no_conformidad_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['fast_search'][2] : "";
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-10", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Delete)", "sc-unique-btn-11", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + C)", "sc-unique-btn-13", "", "group_2");?>
  </div>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "breload", "scBtnFn_sys_format_reload()", "scBtnFn_sys_format_reload()", "sc_b_reload_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-14", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?> 
    ...
    <TD class="scFormDataOdd css_aut_int_ext_line" id="hidden_field_data_aut_int_ext" style="<?php echo $sStyleHidden_aut_int_ext; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aut_int_ext_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_aut_int_ext_label" style=""><span id="id_label_aut_int_ext"><?php echo $this->nm_new_label['aut_int_ext']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['Lookup_aut_int_ext'][] = 'yes'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_proces_line" id="hidden_field_data_proces" style="<?php echo $sStyleHidden_proces; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proces_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_proces_label" style=""><span id="id_label_proces"><?php echo $this->nm_new_label['proces']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['Lookup_proces'][] = 'yes'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_acc_correc_line" id="hidden_field_data_acc_correc" style="<?php echo $sStyleHidden_acc_correc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acc_correc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_acc_correc_label" style=""><span id="id_label_acc_correc"><?php echo $this->nm_new_label['acc_correc']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['Lookup_acc_correc'][] = 'yes'; ?>
...
<?php $sStyleHidden_numero_parte_dumb = ('' == $sStyleHidden_numero_parte) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_numero_parte_dumb" style="<?php echo $sStyleHidden_numero_parte_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $sStyleHidden_clausula_iso_dumb = ('' == $sStyleHidden_clausula_iso) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_clausula_iso_dumb" style="<?php echo $sStyleHidden_clausula_iso_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $sStyleHidden_contencion_dumb = ('' == $sStyleHidden_contencion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_contencion_dumb" style="<?php echo $sStyleHidden_contencion_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $sStyleHidden_descrip_problema_dumb = ('' == $sStyleHidden_descrip_problema) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_descrip_problema_dumb" style="<?php echo $sStyleHidden_descrip_problema_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $sStyleHidden_causa_raiz_dumb = ('' == $sStyleHidden_causa_raiz) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_causa_raiz_dumb" style="<?php echo $sStyleHidden_causa_raiz_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8592;)", "sc-unique-btn-18", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8594;)", "sc-unique-btn-20", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8594;)", "sc-unique-btn-21", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_iso_no_conformidad_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_iso_no_conformidad_mob");
 parent.scAjaxDetailHeight("form_iso_no_conformidad_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_reload() {
		if ($("#sc_b_reload_t.sc-unique-btn-14").length && $("#sc_b_reload_t.sc-unique-btn-14").is(":visible")) {
			scAjax_formReload();
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
