...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["descrip_problema"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["descrip_problema"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["descrip_problema"] : "Descrip Problema";
   $tab_ger_campos['contencion'] = "on";
   $tab_def_campos['contencion'] = "contencion";
   $tab_labels["contencion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["contencion"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["contencion"] : "Contencion";
   $tab_ger_campos['causa_raiz'] = "on";
   $tab_def_campos['causa_raiz'] = "causa_raiz";
   $tab_labels["causa_raiz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["causa_raiz"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["causa_raiz"] : "Causa Raiz";
   $tab_ger_campos['imp_acc_correc'] = "on";
   $tab_def_campos['imp_acc_correc'] = "imp_acc_correc";
   $tab_labels["imp_acc_correc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["imp_acc_correc"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["imp_acc_correc"] : "Imp Acc Correc";
   ...
   $tab_labels["fehca_real"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["fehca_real"])) ? $_SESSION['sc_session'][$sc_init]['grid_iso_no_conformidad']['labels']["fehca_real"] : "Fehca Real";
