<?php
@session_start() ;
$_SESSION['scriptcase']['grid_iso_no_conformidad']['sc_process_barr'] = true;
require_once('../grid_iso_no_conformidad/index.php');
unset($_SESSION['scriptcase']['grid_iso_no_conformidad']['sc_process_barr']);
$ExportCtrl = new grid_iso_no_conformidad_export_control;
$ExportCtrl->Export_barr();

class grid_iso_no_conformidad_export_control
{
