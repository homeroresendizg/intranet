...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BBB_ISO9001_____grid_iso_no_conformidad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BBB_ISO9001_____grid_iso_no_conformidad"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_iso_no_conformidad'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_iso_no_conformidad</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_iso_no_conformidad']['embutida_filho'] as $ind => $sc_init)
          {
