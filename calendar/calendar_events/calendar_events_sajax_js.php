  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_events" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate title
  function do_ajax_calendar_events_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_title(var_title, var_script_case_init, do_ajax_calendar_events_validate_title_cb);
  } // do_ajax_calendar_events_validate_title

  function do_ajax_calendar_events_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_title_cb

  // ---------- Validate description
  function do_ajax_calendar_events_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_description(var_description, var_script_case_init, do_ajax_calendar_events_validate_description_cb);
  } // do_ajax_calendar_events_validate_description

  function do_ajax_calendar_events_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_description_cb

  // ---------- Validate start_date
  function do_ajax_calendar_events_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_calendar_events_validate_start_date(var_start_date, var_script_case_init, do_ajax_calendar_events_validate_start_date_cb);
    }, 200);
  } // do_ajax_calendar_events_validate_start_date

  function do_ajax_calendar_events_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_calendar_events_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_end_date(var_end_date, var_script_case_init, do_ajax_calendar_events_validate_end_date_cb);
  } // do_ajax_calendar_events_validate_end_date

  function do_ajax_calendar_events_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_calendar_events_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendar_events_validate_start_time_cb);
  } // do_ajax_calendar_events_validate_start_time

  function do_ajax_calendar_events_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_calendar_events_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_end_time(var_end_time, var_script_case_init, do_ajax_calendar_events_validate_end_time_cb);
  } // do_ajax_calendar_events_validate_end_time

  function do_ajax_calendar_events_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_end_time_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_calendar_events_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_calendar_events_validate___calend_all_day___cb);
  } // do_ajax_calendar_events_validate___calend_all_day__

  function do_ajax_calendar_events_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate___calend_all_day___cb

  // ---------- Validate period
  function do_ajax_calendar_events_validate_period()
  {
    var nomeCampo_period = "period";
    var var_period = scAjaxGetFieldSelect(nomeCampo_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_events_validate_period(var_period, var_script_case_init, do_ajax_calendar_events_validate_period_cb);
  } // do_ajax_calendar_events_validate_period

  function do_ajax_calendar_events_validate_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "period";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_events_validate_period_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_events_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_events_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_events_submit_form(var_title, var_description, var_start_date, var_end_date, var_start_time, var_end_time, var___calend_all_day__, var_period, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_events_submit_form_cb);
  } // do_ajax_calendar_events_submit_form

  function do_ajax_calendar_events_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_events_submit_form_cb_after_alert);
  } // do_ajax_calendar_events_submit_form_cb
  function do_ajax_calendar_events_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_events_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_events_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_calendar_events_navigate_form, function() {});
    } else {
      perform_ajax_calendar_events_navigate_form();
    }
  }

  function perform_ajax_calendar_events_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendar_events_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_events_navigate_form_cb);
  } // do_ajax_calendar_events_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_events']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_events_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_events_navigate_form_cb_after_alert);
  } // do_ajax_calendar_events_navigate_form_cb
  function do_ajax_calendar_events_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_events_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_events_navigate_form_cb_after_alert
  function sc_hide_calendar_events_form()
  {
