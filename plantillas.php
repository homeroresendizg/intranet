    ...
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
        ...
        <ul class="breadcrumbs-custom-path mt-2 text-center">
          ...
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Plantillas </li>
        </ul>
      </div>
    </div>
  </section>
        ...
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-6">
            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
              <div class="icon-info">
                <h5>Plantillas</h5>
                <p class="mt-3">
                  Plantillas <a href="./plantillas_powerpoint.html">PowerPoint</a> para presentaciones al estilo BBB.
                  <br>

                  <br> <strong>Información de plantillas (Formatos).</strong> <br>
                  La mayor parte de los formatos estan hechos en <a href="plantillas_excel.html">Excel</a>, entre los
                  cuales
                  encontraras solo los de uso mas comun para llenar en la computadora.<br>

                  Los formatos que se requieren solo para imprimir, estan presentados con el formato de <a href="plantillas_adobe.html">Adobe Acrobat</a> (pdf), ademas tenemos <a href="plantillas_adobe.html">calendarios</a> para imprimir.<br>

                  <br> <strong>Información de plantillas (Procedimientos).</strong> <br>
                  En la sección de <a href="plantillas_word.html">Word</a> mostramos las plantillas para los
                  procedimientos,
                  instrucciones, cartas de proceso, evidencias de juntas entre otros.
                </p>
              </div>
          ...
          <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
            <div class="btn-group-vertical">
              <a href="./" class="btn btn-outline-secondary"><i class='fas fa-file' style='font-size:36px;color:#fe5a0e'>
                  Plantillas</i></a><br>
              <a href="./" class="btn btn-outline-secondary"><i class='fas fa-file-excel' style='font-size:36px;color:#fe5a0e'> Excel</i></a><br>
              <a href="./" class="btn btn-outline-secondary"><i class='fas fa-file-word' style='font-size:36px;color:#fe5a0e'> Word</i></a><br>
              <a href="./" class="btn btn-outline-secondary"><i class='fas fa-file-powerpoint' style='font-size:36px;color:#fe5a0e'> PowerPoint</i></a><br>
              <a href="./" class="btn btn-outline-secondary"><i class='fas fa-file-pdf' style='font-size:36px;color:#fe5a0e'> Adobe Acrobat</i></a><br>
            </div>
          </div>
        </div>
      </div>
