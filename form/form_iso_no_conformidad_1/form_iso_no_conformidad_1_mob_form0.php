...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_iso_no_conformidad_1_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_iso_no_conformidad_1_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_iso_no_conformidad_1']['error_buffer']) && '' != $_SESSION['scriptcase']['form_iso_no_conformidad_1']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_iso_no_conformidad_1']['error_buffer'];
}
...
<?php
 include_once("form_iso_no_conformidad_1_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_iso_no_conformidad_1_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_iso_no_conformidad_1_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_iso_no_conformidad_1_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['nombre_proceso'] = (isset($this->nm_new_label['nombre_proceso'])) ? $this->nm_new_label['nombre_proceso'] : 'Nombre de proceso'; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-7", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-8", "", "group_2");?>
  </div>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_iniciador_line" id="hidden_field_data_iniciador" style="<?php echo $sStyleHidden_iniciador; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iniciador_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_iniciador_label" style=""><span id="id_label_iniciador"><?php echo $this->nm_new_label['iniciador']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['iniciador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['iniciador'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sac_line" id="hidden_field_data_sac" style="<?php echo $sStyleHidden_sac; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sac_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sac_label" style=""><span id="id_label_sac"><?php echo $this->nm_new_label['sac']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['sac']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['sac'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombre_proceso_line" id="hidden_field_data_nombre_proceso" style="<?php echo $sStyleHidden_nombre_proceso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_proceso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nombre_proceso_label" style=""><span id="id_label_nombre_proceso"><?php echo $this->nm_new_label['nombre_proceso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['nombre_proceso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['nombre_proceso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_apertura_line" id="hidden_field_data_fecha_apertura" style="<?php echo $sStyleHidden_fecha_apertura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_apertura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_apertura_label" style=""><span id="id_label_fecha_apertura"><?php echo $this->nm_new_label['fecha_apertura']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_apertura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_apertura'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_cierre_line" id="hidden_field_data_fecha_cierre" style="<?php echo $sStyleHidden_fecha_cierre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_cierre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_cierre_label" style=""><span id="id_label_fecha_cierre"><?php echo $this->nm_new_label['fecha_cierre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_cierre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_cierre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_parte_line" id="hidden_field_data_numero_parte" style="<?php echo $sStyleHidden_numero_parte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_parte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numero_parte_label" style=""><span id="id_label_numero_parte"><?php echo $this->nm_new_label['numero_parte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clausula_iso_line" id="hidden_field_data_clausula_iso" style="<?php echo $sStyleHidden_clausula_iso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clausula_iso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clausula_iso_label" style=""><span id="id_label_clausula_iso"><?php echo $this->nm_new_label['clausula_iso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['clausula_iso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['clausula_iso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descrip_problema_line" id="hidden_field_data_descrip_problema" style="<?php echo $sStyleHidden_descrip_problema; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descrip_problema_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descrip_problema_label" style=""><span id="id_label_descrip_problema"><?php echo $this->nm_new_label['descrip_problema']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['descrip_problema']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['descrip_problema'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_contencion_line" id="hidden_field_data_contencion" style="<?php echo $sStyleHidden_contencion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contencion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_contencion_label" style=""><span id="id_label_contencion"><?php echo $this->nm_new_label['contencion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['contencion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['contencion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_causa_raiz_line" id="hidden_field_data_causa_raiz" style="<?php echo $sStyleHidden_causa_raiz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_causa_raiz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_causa_raiz_label" style=""><span id="id_label_causa_raiz"><?php echo $this->nm_new_label['causa_raiz']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['causa_raiz']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['causa_raiz'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_imp_acc_correc_line" id="hidden_field_data_imp_acc_correc" style="<?php echo $sStyleHidden_imp_acc_correc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imp_acc_correc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_imp_acc_correc_label" style=""><span id="id_label_imp_acc_correc"><?php echo $this->nm_new_label['imp_acc_correc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['imp_acc_correc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['imp_acc_correc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_responsable_line" id="hidden_field_data_responsable" style="<?php echo $sStyleHidden_responsable; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_responsable_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_responsable_label" style=""><span id="id_label_responsable"><?php echo $this->nm_new_label['responsable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['responsable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['responsable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_compro_line" id="hidden_field_data_fecha_compro" style="<?php echo $sStyleHidden_fecha_compro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_compro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_compro_label" style=""><span id="id_label_fecha_compro"><?php echo $this->nm_new_label['fecha_compro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_compro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fecha_compro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fehca_real_line" id="hidden_field_data_fehca_real" style="<?php echo $sStyleHidden_fehca_real; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fehca_real_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fehca_real_label" style=""><span id="id_label_fehca_real"><?php echo $this->nm_new_label['fehca_real']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fehca_real']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['php_cmp_required']['fehca_real'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_iso_no_conformidad_1_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_iso_no_conformidad_1_mob");
 parent.scAjaxDetailHeight("form_iso_no_conformidad_1_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
