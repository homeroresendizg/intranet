  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_iso_no_conformidad_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_iso_no_conformidad_1_form();
	}
  ...
  // ---------- Validate iniciador
  function do_ajax_form_iso_no_conformidad_1_validate_iniciador()
  {
    var nomeCampo_iniciador = "iniciador";
    var var_iniciador = scAjaxGetFieldText(nomeCampo_iniciador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_iniciador(var_iniciador, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_iniciador_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_iniciador

  function do_ajax_form_iso_no_conformidad_1_validate_iniciador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_iniciador_cb

  // ---------- Validate sac
  function do_ajax_form_iso_no_conformidad_1_validate_sac()
  {
    var nomeCampo_sac = "sac";
    var var_sac = scAjaxGetFieldText(nomeCampo_sac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_sac(var_sac, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_sac_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_sac

  function do_ajax_form_iso_no_conformidad_1_validate_sac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sac";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_sac_cb

  // ---------- Validate nombre_proceso
  function do_ajax_form_iso_no_conformidad_1_validate_nombre_proceso()
  {
    var nomeCampo_nombre_proceso = "nombre_proceso";
    var var_nombre_proceso = scAjaxGetFieldText(nomeCampo_nombre_proceso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_nombre_proceso(var_nombre_proceso, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_nombre_proceso_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_nombre_proceso

  function do_ajax_form_iso_no_conformidad_1_validate_nombre_proceso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_nombre_proceso_cb

  // ---------- Validate fecha_apertura
  function do_ajax_form_iso_no_conformidad_1_validate_fecha_apertura()
  {
    ...
    setTimeout(function() {
      var var_fecha_apertura = scAjaxGetFieldText(nomeCampo_fecha_apertura);
      x_ajax_form_iso_no_conformidad_1_validate_fecha_apertura(var_fecha_apertura, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_fecha_apertura_cb);
    }, 200);
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_apertura

  function do_ajax_form_iso_no_conformidad_1_validate_fecha_apertura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_apertura_cb

  // ---------- Validate fecha_cierre
  function do_ajax_form_iso_no_conformidad_1_validate_fecha_cierre()
  {
    ...
    setTimeout(function() {
      var var_fecha_cierre = scAjaxGetFieldText(nomeCampo_fecha_cierre);
      x_ajax_form_iso_no_conformidad_1_validate_fecha_cierre(var_fecha_cierre, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_fecha_cierre_cb);
    }, 200);
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_cierre

  function do_ajax_form_iso_no_conformidad_1_validate_fecha_cierre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_cierre_cb

  // ---------- Validate numero_parte
  function do_ajax_form_iso_no_conformidad_1_validate_numero_parte()
  {
    var nomeCampo_numero_parte = "numero_parte";
    var var_numero_parte = scAjaxGetFieldText(nomeCampo_numero_parte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_numero_parte(var_numero_parte, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_numero_parte_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_numero_parte

  function do_ajax_form_iso_no_conformidad_1_validate_numero_parte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_numero_parte_cb

  // ---------- Validate clausula_iso
  function do_ajax_form_iso_no_conformidad_1_validate_clausula_iso()
  {
    var nomeCampo_clausula_iso = "clausula_iso";
    var var_clausula_iso = scAjaxGetFieldText(nomeCampo_clausula_iso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_clausula_iso(var_clausula_iso, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_clausula_iso_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_clausula_iso

  function do_ajax_form_iso_no_conformidad_1_validate_clausula_iso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_clausula_iso_cb

  // ---------- Validate descrip_problema
  function do_ajax_form_iso_no_conformidad_1_validate_descrip_problema()
  {
    var nomeCampo_descrip_problema = "descrip_problema";
    var var_descrip_problema = scAjaxGetFieldText(nomeCampo_descrip_problema);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_descrip_problema(var_descrip_problema, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_descrip_problema_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_descrip_problema

  function do_ajax_form_iso_no_conformidad_1_validate_descrip_problema_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_descrip_problema_cb

  // ---------- Validate contencion
  function do_ajax_form_iso_no_conformidad_1_validate_contencion()
  {
    var nomeCampo_contencion = "contencion";
    var var_contencion = scAjaxGetFieldText(nomeCampo_contencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_contencion(var_contencion, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_contencion_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_contencion

  function do_ajax_form_iso_no_conformidad_1_validate_contencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_contencion_cb

  // ---------- Validate causa_raiz
  function do_ajax_form_iso_no_conformidad_1_validate_causa_raiz()
  {
    var nomeCampo_causa_raiz = "causa_raiz";
    var var_causa_raiz = scAjaxGetFieldText(nomeCampo_causa_raiz);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_causa_raiz(var_causa_raiz, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_causa_raiz_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_causa_raiz

  function do_ajax_form_iso_no_conformidad_1_validate_causa_raiz_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_causa_raiz_cb

  // ---------- Validate imp_acc_correc
  function do_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc()
  {
    var nomeCampo_imp_acc_correc = "imp_acc_correc";
    var var_imp_acc_correc = scAjaxGetFieldText(nomeCampo_imp_acc_correc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc(var_imp_acc_correc, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc

  function do_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_imp_acc_correc_cb

  // ---------- Validate responsable
  function do_ajax_form_iso_no_conformidad_1_validate_responsable()
  {
    var nomeCampo_responsable = "responsable";
    var var_responsable = scAjaxGetFieldText(nomeCampo_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_1_validate_responsable(var_responsable, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_responsable_cb);
  } // do_ajax_form_iso_no_conformidad_1_validate_responsable

  function do_ajax_form_iso_no_conformidad_1_validate_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_responsable_cb

  // ---------- Validate fecha_compro
  function do_ajax_form_iso_no_conformidad_1_validate_fecha_compro()
  {
    ...
    setTimeout(function() {
      var var_fecha_compro = scAjaxGetFieldText(nomeCampo_fecha_compro);
      x_ajax_form_iso_no_conformidad_1_validate_fecha_compro(var_fecha_compro, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_fecha_compro_cb);
    }, 200);
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_compro

  function do_ajax_form_iso_no_conformidad_1_validate_fecha_compro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_fecha_compro_cb

  // ---------- Validate fehca_real
  function do_ajax_form_iso_no_conformidad_1_validate_fehca_real()
  {
    ...
    setTimeout(function() {
      var var_fehca_real = scAjaxGetFieldText(nomeCampo_fehca_real);
      x_ajax_form_iso_no_conformidad_1_validate_fehca_real(var_fehca_real, var_script_case_init, do_ajax_form_iso_no_conformidad_1_validate_fehca_real_cb);
    }, 200);
  } // do_ajax_form_iso_no_conformidad_1_validate_fehca_real

  function do_ajax_form_iso_no_conformidad_1_validate_fehca_real_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_1_validate_fehca_real_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_iso_no_conformidad_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_iso_no_conformidad_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_iso_no_conformidad_1_submit_form(var_iniciador, var_sac, var_nombre_proceso, var_fecha_apertura, var_fecha_cierre, var_numero_parte, var_clausula_iso, var_descrip_problema, var_contencion, var_causa_raiz, var_imp_acc_correc, var_responsable, var_fecha_compro, var_fehca_real, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_iso_no_conformidad_1_submit_form_cb);
  } // do_ajax_form_iso_no_conformidad_1_submit_form

  function do_ajax_form_iso_no_conformidad_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_iso_no_conformidad_1_submit_form_cb_after_alert);
  } // do_ajax_form_iso_no_conformidad_1_submit_form_cb
  function do_ajax_form_iso_no_conformidad_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_iso_no_conformidad_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_iso_no_conformidad_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_iso_no_conformidad_1_navigate_form, function() {});
    } else {
      perform_ajax_form_iso_no_conformidad_1_navigate_form();
    }
  }

  function perform_ajax_form_iso_no_conformidad_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_iso_no_conformidad_1_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iso_no_conformidad_1_navigate_form_cb);
  } // do_ajax_form_iso_no_conformidad_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iso_no_conformidad_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_iso_no_conformidad_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_iso_no_conformidad_1_navigate_form_cb_after_alert);
  } // do_ajax_form_iso_no_conformidad_1_navigate_form_cb
  function do_ajax_form_iso_no_conformidad_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_iso_no_conformidad_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_iso_no_conformidad_1_navigate_form_cb_after_alert
  function sc_hide_form_iso_no_conformidad_1_form()
  {
