...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate iniciador_
  function do_ajax_form_iso_no_conformidad_validate_iniciador_(iNumLinha)
  {
    var nomeCampo_iniciador_ = "iniciador_" + iNumLinha;
    var var_iniciador_ = scAjaxGetFieldText(nomeCampo_iniciador_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_validate_iniciador_(var_iniciador_, iNumLinha, var_script_case_init, do_ajax_form_iso_no_conformidad_validate_iniciador__cb);
  } // do_ajax_form_iso_no_conformidad_validate_iniciador_

  function do_ajax_form_iso_no_conformidad_validate_iniciador__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "iniciador_" + iLineNumber;
    }
    else
    {
      sFieldValid = "iniciador_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "iniciador_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "iniciador_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_validate_iniciador__cb

  // ---------- Validate sac_
  function do_ajax_form_iso_no_conformidad_validate_sac_(iNumLinha)
  {
    var nomeCampo_sac_ = "sac_" + iNumLinha;
    var var_sac_ = scAjaxGetFieldText(nomeCampo_sac_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_validate_sac_(var_sac_, iNumLinha, var_script_case_init, do_ajax_form_iso_no_conformidad_validate_sac__cb);
  } // do_ajax_form_iso_no_conformidad_validate_sac_

  function do_ajax_form_iso_no_conformidad_validate_sac__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sac_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sac_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_validate_sac__cb

  // ---------- Validate nombre_proceso_
  function do_ajax_form_iso_no_conformidad_validate_nombre_proceso_(iNumLinha)
  {
    var nomeCampo_nombre_proceso_ = "nombre_proceso_" + iNumLinha;
    var var_nombre_proceso_ = scAjaxGetFieldText(nomeCampo_nombre_proceso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_validate_nombre_proceso_(var_nombre_proceso_, iNumLinha, var_script_case_init, do_ajax_form_iso_no_conformidad_validate_nombre_proceso__cb);
  } // do_ajax_form_iso_no_conformidad_validate_nombre_proceso_

  function do_ajax_form_iso_no_conformidad_validate_nombre_proceso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_proceso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_proceso_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_proceso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_proceso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_validate_nombre_proceso__cb

  // ---------- Validate fecha_apertura_
  function do_ajax_form_iso_no_conformidad_validate_fecha_apertura_(iNumLinha)
  {
    var nomeCampo_fecha_apertura_ = "fecha_apertura_" + iNumLinha;
    var var_fecha_apertura_ = scAjaxGetFieldText(nomeCampo_fecha_apertura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_validate_fecha_apertura_(var_fecha_apertura_, iNumLinha, var_script_case_init, do_ajax_form_iso_no_conformidad_validate_fecha_apertura__cb);
  } // do_ajax_form_iso_no_conformidad_validate_fecha_apertura_

  function do_ajax_form_iso_no_conformidad_validate_fecha_apertura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_apertura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_apertura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_apertura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_apertura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_validate_fecha_apertura__cb

  // ---------- Validate fecha_cierre_
  function do_ajax_form_iso_no_conformidad_validate_fecha_cierre_(iNumLinha)
  {
    var nomeCampo_fecha_cierre_ = "fecha_cierre_" + iNumLinha;
    var var_fecha_cierre_ = scAjaxGetFieldText(nomeCampo_fecha_cierre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_validate_fecha_cierre_(var_fecha_cierre_, iNumLinha, var_script_case_init, do_ajax_form_iso_no_conformidad_validate_fecha_cierre__cb);
  } // do_ajax_form_iso_no_conformidad_validate_fecha_cierre_

  function do_ajax_form_iso_no_conformidad_validate_fecha_cierre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_cierre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_cierre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_cierre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_cierre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iso_no_conformidad_validate_fecha_cierre__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_iso_no_conformidad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_iso_no_conformidad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_iso_no_conformidad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_iso_no_conformidad_add_new_line_cb);
  } // do_ajax_form_iso_no_conformidad_add_new_line

  function do_ajax_form_iso_no_conformidad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_iso_no_conformidad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_iso_no_conformidad_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iso_no_conformidad_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_iso_no_conformidad_backup_line_cb);
  } // do_ajax_form_iso_no_conformidad_backup_line

  function do_ajax_form_iso_no_conformidad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_iso_no_conformidad_backup_line_cb

  function do_ajax_form_iso_no_conformidad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_iso_no_conformidad_cancel_insert

  function do_ajax_form_iso_no_conformidad_cancel_update(iSeqVert)
  {
    do_ajax_form_iso_no_conformidad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_iso_no_conformidad_cancel_update

  function do_ajax_form_iso_no_conformidad_restore_buttons()
  {
<?php
...
?>
  ...
  // ---------- table_refresh
  function do_ajax_form_iso_no_conformidad_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_iso_no_conformidad_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iso_no_conformidad_table_refresh_cb);
  } //  do_ajax_form_iso_no_conformidad_table_refresh

  function do_ajax_form_iso_no_conformidad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_iso_no_conformidad_table_refresh_cb_after_alert);
  } // do_ajax_form_iso_no_conformidad_table_refresh_cb
  function do_ajax_form_iso_no_conformidad_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_iso_no_conformidad_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_iso_no_conformidad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_iso_no_conformidad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_iniciador_ = scAjaxGetFieldText("iniciador_" + iNumLinha);
    var var_sac_ = scAjaxGetFieldText("sac_" + iNumLinha);
    var var_nombre_proceso_ = scAjaxGetFieldText("nombre_proceso_" + iNumLinha);
    var var_fecha_apertura_ = scAjaxGetFieldText("fecha_apertura_" + iNumLinha);
    var var_fecha_cierre_ = scAjaxGetFieldText("fecha_cierre_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_iso_no_conformidad_submit_form(var_iniciador_, var_sac_, var_nombre_proceso_, var_fecha_apertura_, var_fecha_cierre_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_iso_no_conformidad_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("iniciador_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sac_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_proceso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fecha_apertura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fecha_cierre_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
  ...
  function perform_ajax_form_iso_no_conformidad_navigate_form()
  {
    ...
    if (sc_insert_open)
    {
        do_ajax_form_iso_no_conformidad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("iniciador_" + iNavForm);
      scAjaxHideErrorDisplay("sac_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_proceso_" + iNavForm);
      scAjaxHideErrorDisplay("fecha_apertura_" + iNavForm);
      scAjaxHideErrorDisplay("fecha_cierre_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_iso_no_conformidad_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iso_no_conformidad_navigate_form_cb);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "iniciador_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sac_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_proceso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_apertura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_cierre_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["iniciador_" + iNumLinha] = {"label": "Iniciador<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sac_" + iNumLinha] = {"label": "SAC#<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_proceso_" + iNumLinha] = {"label": "Nombre proceso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fecha_apertura_" + iNumLinha] = {"label": "Fecha de apertura<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fecha_cierre_" + iNumLinha] = {"label": "Fecha de cierre<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["iniciador_"][iNumLinha] = "iniciador_" + iNumLinha;
    ajax_field_mult["sac_"][iNumLinha] = "sac_" + iNumLinha;
    ajax_field_mult["nombre_proceso_"][iNumLinha] = "nombre_proceso_" + iNumLinha;
    ajax_field_mult["fecha_apertura_"][iNumLinha] = "fecha_apertura_" + iNumLinha;
    ajax_field_mult["fecha_cierre_"][iNumLinha] = "fecha_cierre_" + iNumLinha;
    ajax_field_id["iniciador_" + iNumLinha] = new Array("hidden_field_label_iniciador_", "hidden_field_data_iniciador_" + iNumLinha);
    ajax_field_id["sac_" + iNumLinha] = new Array("hidden_field_label_sac_", "hidden_field_data_sac_" + iNumLinha);
    ajax_field_id["nombre_proceso_" + iNumLinha] = new Array("hidden_field_label_nombre_proceso_", "hidden_field_data_nombre_proceso_" + iNumLinha);
    ajax_field_id["fecha_apertura_" + iNumLinha] = new Array("hidden_field_label_fecha_apertura_", "hidden_field_data_fecha_apertura_" + iNumLinha);
    ajax_field_id["fecha_cierre_" + iNumLinha] = new Array("hidden_field_label_fecha_cierre_", "hidden_field_data_fecha_cierre_" + iNumLinha);
    ajax_error_count["iniciador_" + iNumLinha] = "off";
    ajax_error_count["sac_" + iNumLinha] = "off";
    ajax_error_count["nombre_proceso_" + iNumLinha] = "off";
    ajax_error_count["fecha_apertura_" + iNumLinha] = "off";
    ajax_error_count["fecha_cierre_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["iniciador_" + iNumLinha] = "on";
    ajax_read_only["sac_" + iNumLinha] = "on";
    ajax_read_only["nombre_proceso_" + iNumLinha] = "on";
    ajax_read_only["fecha_apertura_" + iNumLinha] = "on";
    ajax_read_only["fecha_cierre_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["iniciador_" + iNumLinha] = null;
    ajax_error_list["sac_" + iNumLinha] = null;
    ajax_error_list["nombre_proceso_" + iNumLinha] = null;
    ajax_error_list["fecha_apertura_" + iNumLinha] = null;
    ajax_error_list["fecha_cierre_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "iniciador_": new Array(),
    "sac_": new Array(),
    "nombre_proceso_": new Array(),
    "fecha_apertura_": new Array(),
    "fecha_cierre_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["iniciador_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["iniciador_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["iniciador_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["iniciador_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["iniciador_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sac_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sac_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sac_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sac_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sac_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_proceso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_proceso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_proceso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_proceso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_proceso_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fecha_apertura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_apertura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_apertura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_apertura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_apertura_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fecha_cierre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_cierre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_cierre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_cierre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_cierre_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['iniciador_'])) ? $this->nmgp_cmp_readonly['iniciador_'] : 'on';
?>
    scAjaxFieldRead("iniciador_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sac_'])) ? $this->nmgp_cmp_readonly['sac_'] : 'on';
?>
    scAjaxFieldRead("sac_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_proceso_'])) ? $this->nmgp_cmp_readonly['nombre_proceso_'] : 'on';
?>
    scAjaxFieldRead("nombre_proceso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_apertura_'])) ? $this->nmgp_cmp_readonly['fecha_apertura_'] : 'on';
?>
    scAjaxFieldRead("fecha_apertura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_cierre_'])) ? $this->nmgp_cmp_readonly['fecha_cierre_'] : 'on';
?>
    scAjaxFieldRead("fecha_cierre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("iniciador_" + iSeq, "on");
    scAjaxFieldRead("sac_" + iSeq, "on");
    scAjaxFieldRead("nombre_proceso_" + iSeq, "on");
    scAjaxFieldRead("fecha_apertura_" + iSeq, "on");
    scAjaxFieldRead("fecha_cierre_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["iniciador_" + iRow] || "on" == ajax_error_count["sac_" + iRow] || "on" == ajax_error_count["nombre_proceso_" + iRow] || "on" == ajax_error_count["fecha_apertura_" + iRow] || "on" == ajax_error_count["fecha_cierre_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_iniciador_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sac_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_proceso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fecha_apertura_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fecha_cierre_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["iniciador_" + iRow] && "off" == ajax_error_count["sac_" + iRow] && "off" == ajax_error_count["nombre_proceso_" + iRow] && "off" == ajax_error_count["fecha_apertura_" + iRow] && "off" == ajax_error_count["fecha_cierre_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["iniciador_" + iRow] = "off";
        ajax_error_count["sac_" + iRow] = "off";
        ajax_error_count["nombre_proceso_" + iRow] = "off";
        ajax_error_count["fecha_apertura_" + iRow] = "off";
        ajax_error_count["fecha_cierre_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_iniciador_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sac_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_proceso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fecha_apertura_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fecha_cierre_" + iRow).removeClass("scFormErrorLine");
    }
  }
