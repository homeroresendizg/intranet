  ...
  <section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
        <h2 class="title">COP's</h2>
        <ul class="breadcrumbs-custom-path mt-2 text-center">
          <li><a href="../">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>COP's</li>
        </ul>
      </div>
    </div>
  </section>
                ...
                <div class="text-center cwp4-text col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="" data-toggle="collapse" data-parent="#custom-collapse-0-3"
                                    href="#custom-collapse-0-3" aria-expanded="false">REVISIÓN GERENCIAL</a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                          <h4 class="panel-title">
                              <a class="" data-toggle="collapse" data-parent="#custom-collapse-0-3"
                                  href="#custom-collapse-0-3" aria-expanded="true">MEDICION, ANALISIS Y MEJORA</a>
                          </h4>
                      </div>
