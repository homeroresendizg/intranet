  ...
  <section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
        <h2 class="title">SOP's</h2>
        <ul class="breadcrumbs-custom-path mt-2 text-center">
          <li><a href="../">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>SOP's</li>
        </ul>
      </div>
    </div>
  </section>
        ...
        <div class="cwp4-two row">
          <div class="text-center cwp4-text col-lg-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a class="" data-toggle="collapse" data-parent="#custom-collapse-0-31" href="#custom-collapse-0-31" aria-expanded="false">REVISIÓN GERENCIAL</a>
                </h4>
              </div>
              <div id="custom-collapse-0-31" class="panel-collapse in collapse show" aria-expanded="true">
                <div class="panel-body">
                  <table class="table table-bordered table-striped">
                    <tbody>
                      <tr>
                        <td>Revisión Gerencial</td>
                      </tr>
                      <tr>
                        <td>MOP-01</td>
                      </tr>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a class="" data-toggle="collapse" data-parent="#custom-collapse-0-3" href="#custom-collapse-0-3" aria-expanded="true">MEDICION, ANALISIS Y MEJORA</a>
                </h4>
              </div>
              <div id="custom-collapse-0-3" class="panel-collapse in collapse" aria-expanded="true">
                <div class="panel-body">
                  <table class="table table-bordered table-striped">
                    <tbody>
                      <tr>
