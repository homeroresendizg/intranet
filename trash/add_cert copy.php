...
<head>
  ...
  <title>BBB Industries de México | Add</title>
      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-12">
            ...
            <form id="form" method="post" name="form" action="auth_cert.php">
              <div class="row">
                <div>
                  <section>
                    <hr />
                    <!-- <div class="row">
                      <div class="col-md-12">
                        ...
                        <input id="title" type="text" name="title" class="form-control" type="text" placeholder="Type the title here" required>
                      </div>
                      <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <label for="example-text-input" class="col-6 col-form-label">URL Document</label>
                        <input id="document" type="text" name="document" class="form-control" type="text" placeholder="Type the URL document here" required>
                      </div>
                      <div class="col-md-12">
                    ...
                    <br>
                    <hr>
                    <input type="submit" name="insertar" class="btn btn-success" value="Add Certification"></button>
                    </p>
                  </section>
                </div>
                <!-- <div class="col-md-4">
