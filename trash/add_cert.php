      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-12">
            ...
            <hr>
            <form method="post" action="add_cert.php" enctype="multipart/form-data">
              ...
              <br>
              <div>
                <textarea name="text" cols="30" rows="4" placeholder="Say something here"></textarea>
              </div>
              <div>
                <input type="submit" name="upload" value="Upload Certification">
              </div>
            </form>
          </div>
        </div>
