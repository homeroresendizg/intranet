...
<head>
  ...
  <title>BBB Industries de México | Certifications</title>
...
<body>
    ...
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
        ...
        <ul class="breadcrumbs-custom-path mt-2 text-center">
          <li><a href="../">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Certificate </li>
        </ul>
      </div>
    </div>
  </section>
  ...
  if (isset($_POST['upload'])) {
    $target = "../assets/uploads/certifications/" . basename($_FILES['image']['name']);
    ...
    $sql = "INSERT INTO tbl_certifications (image, text) VALUES ('$image', '$text')";
    mysqli_query($db, $sql);

    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
      $msg = "Image uploaled successfully!";
    } else {
      $msg = "There was a problem uploading the certification";
    }
  }
  ?>
      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-12">
            <h3 class="title-big">New Certification </h3>
            <hr>
            <form method="post" action="../certifications/index.php" enctype="multipart/form-data">
              ...
              <br>
              <div>
                <textarea name="text" cols="30" rows="4" placeholder="Upload Certification"></textarea>
              </div>
              <div>
                <input type="submit" name="upload" value="Upload Certification" class="btn btn-small btn-success mt-sm-5 mt-4">
                <a class="btn btn-small btn-danger mt-sm-5 mt-4" href="../certifications/home.php">Cancel</a>
              </div>
            </form>
