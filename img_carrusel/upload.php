...
<head>
  ...
  <title>BBB Industries de México | Images</title>
...
<body>
        ...
        ?>
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mx-lg-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="http://192.168.1.68/bbb_intranet/no_conf/grid_iso_no_conformidad/" target="_blank">Tracking</a>
              </li>
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="../certifications/home.php">Certification</a>
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="#">New images</a>
                </div>
              </li>
    ...
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
        ...
        <ul class="breadcrumbs-custom-path mt-2 text-center">
          ...
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Images </li>
        </ul>
      </div>
    </div>
  </section>
  ...
  if (isset($_POST['upload3'])) {
    $target = "../assets/uploads/images/" . basename($_FILES['image']['name']);

    $db = mysqli_connect("192.168.1.180", "bbb_admin", "@BBB123", "bbb_intranet");
      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-12">
            ...
            <hr>
            <form method="post" action="../img_carrusel/upload.php" enctype="multipart/form-data">
              ...
              <br>
              <div>
                <textarea name="text" cols="30" rows="4" placeholder="Type here a description"></textarea>
              </div>
              <div>
                <input type="submit" name="upload3" value="Upload image" class="btn btn-small btn-success mt-sm-5 mt-4">
                <a class="btn btn-small btn-danger mt-sm-5 mt-4" href="../home.php">Cancel</a>
              </div>
            </form>
          </div>
        </div>
