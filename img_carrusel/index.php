      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-12">
            ...
            ?>
            <form method="POST" action="upload.php" enctype="multipart/form-data"><hr style="border-color: transparent;">
              <div>
                <span>Select a image to upload a new certification</span>
                <input type="file" name="uploadedFile" /><hr style="border-color: transparent;">
              </div>
              <input type="submit" class="btn btn-success" name="uploadBtn" value="Upload" />
            </form>
