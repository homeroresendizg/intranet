...
try {
    ...
    $consultaSQL = "SELECT * FROM directorios WHERE locacion = 'Caliper'";
    ...
    <section class="w3l-about-breadcrumb">
        <div class="breadcrumb-bg breadcrumb-bg-about py-5">
            <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
                <h2 class="title">Caliper Directory</h2>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#phpecho" href="#custom-collapse-0-3" aria-expanded="true">Caliper</a>
                                </h4>
                            </div>
