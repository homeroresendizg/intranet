...
try {
    ...
    $consultaSQL = "SELECT DISTINCT departamento FROM directorios WHERE locacion = 'BBBIndustries-RADIO'";
    ...
    <section class="w3l-about-breadcrumb">
        <div class="breadcrumb-bg breadcrumb-bg-about py-5">
            <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
                <h2 class="title">BBBIndustries-RADIO Directory</h2>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><strong>Departament</strong></th>
                                                        <th><strong>Canal</strong></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $consultaSQL1 = "SELECT * FROM directorios WHERE departamento = '" . $fila["departamento"] . "' AND locacion = 'BBBIndustries-RADIO'";
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <td><?php echo ($fila1["planta"]); ?></td>
                                                                <td><?php echo ($fila1["nombre"]); ?></td>
                                                                <td><?php echo ($fila1["departamento"]); ?></td>
                                                                <td><?php echo ($fila1["canal"]); ?></td>
                                                            </tr>
                                                    <?php
                                                        }
                                                    }
