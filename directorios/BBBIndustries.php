...
try {
    ...
    $consultaSQL = "SELECT DISTINCT departamento FROM directorios WHERE locacion = 'BBBIndustries'";
...
<head>
    ...
    <title>BBB Industries de Mexico | Diretory</title>
    ...
    <section class="w3l-about-breadcrumb">
        <div class="breadcrumb-bg breadcrumb-bg-about py-5">
            <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
                <h2 class="title">BBBIndustries Directory</h2>
                                    ...
                                    <div id="custom-collapse-0-3" class="panel-collapse in collapse show" aria-expanded="true">
                                        <div class="panel-body">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $consultaSQL1 = "SELECT * FROM directorios WHERE departamento = '" . $fila["departamento"] . "' AND locacion = 'BBBIndustries'";
