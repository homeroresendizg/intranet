      ...
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-lg-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://192.168.1.68/bbb_dlib_rem/grid_tb_documents_main/">Documents</a>
            </li>
      ...
      <div class="container py-lg-5 py-md-4">
        <div class="cwp4-two row">
          <div class="cwp4-text col-lg-6">
            <h2 class="title-big" style="color: red;">USER INCORRECT! </h2>
            <br>
            <h3>Verify your credentials </h3>
            <br>
            <a class="btn btn-style btn-primary mt-sm-5 mt-4" href="./add_cert.php">&#8630; Return</a>
          </div>
          <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
            <img src="./assets/images/wronguser.jpg" class="radius-image img-fluid" alt="" />
          </div>
        </div>
      </div>
    </div>
