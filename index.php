            ...
            <div class="row">
                <div class="col-6">
                    <h3 class="title-big">Gallery
                        <!-- <a href="img_carrusel/add_img.php" class="btn btn-lg btn-primary rounded-pill">+ Add image</a> -->
                    </h3>
                    <br>
                </div>
                <div class="col-12">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/BBB-Industries.jpg" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/2.png" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                                <h4 class="card-title">Special title treatment</h4>
                                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                            </div> -->
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/5.png" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                                <h4 class="card-title">Special title treatment</h4>
                                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                            </div> -->
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/6.png" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                                <h4 class="card-title">Special title treatment</h4>
                                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                            </div> -->
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/4.png" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                                <h4 class="card-title">Special title treatment</h4>
                                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                            </div> -->
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img class="img-fluid" alt="100%x280" src="assets/images/9.png" style="width: 2100px; height: 220px;">
                                            <!-- <div class="card-body">
                                                <h4 class="card-title">Special title treatment</h4>
                                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                            </div> -->
            ...
            <div class="container pb-lg-5 pb-md-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-sm-5 mt-4 align-self">
                        ...
                        <a href="./processmap.php" class="btn btn-style btn-primary mt-sm-5 mt-4">See more</a>
                    </div>
                </div>
            </div>
        </div>
